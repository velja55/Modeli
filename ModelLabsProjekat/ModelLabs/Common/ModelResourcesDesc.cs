...
{	
	...
	public class ModelResourcesDesc
	{
            ...
            private void InitializeTypeIdsInInsertOrder()
        {
            ...
            // 1. Osnovni tipovi bez zavisnosti
            typeIdsInInsertOrder.Add(ModelCode.DAYTYPE);
            typeIdsInInsertOrder.Add(ModelCode.TRM); // TERMINAL

            // 2. Tip koji zavisi od Terminala
            typeIdsInInsertOrder.Add(ModelCode.RG_CNTRL); // REGULATINGCONTROL

            // 3. Tipovi koji zavise od RegulatingControl-a
            typeIdsInInsertOrder.Add(ModelCode.SHUNT_COMP); // SHUNTCOMPENSATOR
            typeIdsInInsertOrder.Add(ModelCode.STAT_VAR_COMP); // STATICVARCOMPENSATOR

            // 4. Tip koji zavisi od više prethodnih
            typeIdsInInsertOrder.Add(ModelCode.REG_SCHEDULE);
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.RG_CNTRL_REG_SCHEDULE);
			notSettablePropertyIds.Add(ModelCode.CONDEQ_TRM);
			notSettablePropertyIds.Add(ModelCode.DAYTYPE_SEASON_DAYTYPE);
            notSettablePropertyIds.Add(ModelCode.RG_CNTRL_REG_CONEQ);	
            notSettablePropertyIds.Add(ModelCode.TRM_REG_CNTRL);	
		}
